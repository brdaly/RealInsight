 ...
 *
 * It is not every response the site serves. The generated Wrangler config sets
 * `assets.directory` without `run_worker_first`, so under Cloudflare's default
 * asset routing every static file, `public/` and `/_next/static/` alike, is
 * served before the Worker is invoked and carries none of these headers.
 *
